...
+ (CBRequestId*) getStatus:(unsigned long long)id delegate:(id)delegate selector:(SEL)selector;           // - (void) statusLoaded:(CBStatus*)status error:(NSError*)error;
...
+ (CBRequestId*) updateStatus:(NSString*)status delegate:(id)delegate selector:(SEL)selector;         // - (void) statusLoaded:(CBStatus*)status error:(NSError*)error;
...
+ (CBRequestId*) deleteStatus:(unsigned long long)id delegate:(id)delegate selector:(SEL)selector;           // - (void) statusDeleted:(NSError*)error;
...
+ (CBRequestId*) retweet:(unsigned long long)id delegate:(id)delegate selector:(SEL)selector;           // - (void) retweetComplete:(CBStatus*)status error:(NSError*)error;
...
+ (CBRequestId*) getRetweetedBy:(unsigned long long)id delegate:(id)delegate selector:(SEL)selector;           // - (void) statusLoaded:(NSArray*)users error:(NSError*)error;
...
+ (CBRequestId*) getRetweetedByIds:(unsigned long long)id delegate:(id)delegate selector:(SEL)selector;           // - (void) statusLoaded:(NSArray*)userIds error:(NSError*)error;
