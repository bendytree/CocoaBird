...
+ (NSString*) getListSubscribersById:(int)list_id delegate:(id)delegate selector:(SEL)selector;           // - (void) listSubscribersLoaded:(CBListSubscribers*)listSubscribers error:(NSError*)error;
...
+ (NSString*) getListSubscribersByName:(NSString*)slug userId:(int)user_id delegate:(id)delegate selector:(SEL)selector;           // - (void) listSubscribersLoaded:(CBListSubscribers*)listSubscribers error:(NSError*)error;
...
+ (NSString*) getListSubscribersByName:(NSString*)slug screenName:(NSString*)screen_name delegate:(id)delegate selector:(SEL)selector;           // - (void) listSubscribersLoaded:(CBListSubscribers*)listSubscribers error:(NSError*)error;
...
+ (NSString*) isUserSubscriberOfList:(CBIsUserSubscriberOfListParams*)params delegate:(id)delegate selector:(SEL)selector;           // - (void) isSubscriberOfListLoaded:(CBUser*)user error:(NSError*)error;
...
+ (NSString*) subscribeToList:(CBSubscribeToListParams*)params delegate:(id)delegate selector:(SEL)selector;           // - (void) subscriberWasAdded:(CBUser*)user error:(NSError*)error;

//Remove Subscriber From List
+ (void) removeSubscriberFromListNow:(CBRemoveSubscriberFromListParams*)params error:(NSError**)error;
+ (NSString*) removeSubscriberFromList:(CBRemoveSubscriberFromListParams*)params delegate:(id)delegate selector:(SEL)selector;           // - (void) subscriberRemoved:(NSError*)error;
