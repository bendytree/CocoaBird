...
+ (CBListMembers*) getListMembersByIdNow:(int)list_id params:(CBGetListMembersParams*)params error:(NSError**)error
{
    ...
    return [self processRequestSynchronous:@"api.twitter.com/1/lists/members.json" method:@"GET" params:params type:CBTwitterResponseTypeCustom class:[CBListMembers class] error:error];
}
...
+ (CBRequestId*) getListMembersById:(int)list_id delegate:(id)delegate selector:(SEL)selector params:(CBGetListMembersParams*)params
{
    params = params ? params : [CBGetListMembersParams params];
    params.list_id = [NSNumber numberWithInt:list_id];
    return [self processRequestAsynchronous:@"api.twitter.com/1/lists/members.json" method:@"GET" params:params type:CBTwitterResponseTypeCustom class:[CBListMembers class] delegate:delegate selector:selector];    
}
...
{
    return [self processRequestSynchronous:@"api.twitter.com/1/lists/members/show.json" method:@"GET" params:params type:CBTwitterResponseTypeCustom class:[CBUser class] error:error];
}

+ (CBRequestId*) isUserMemberOfList:(CBIsUserMemberOfListParams*)params delegate:(id)delegate selector:(SEL)selector
{
    return [self processRequestAsynchronous:@"api.twitter.com/1/lists/members/show.json" method:@"GET" params:params type:CBTwitterResponseTypeCustom class:[CBUser class] delegate:delegate selector:selector];    
}
...
{
    return [self processRequestSynchronous:@"api.twitter.com/1/lists/members/create.json" method:@"POST" params:params type:CBTwitterResponseTypeCustom class:[CBUser class] error:error];
}

+ (CBRequestId*) addMemberToList:(CBAddMemberToListParams*)params delegate:(id)delegate selector:(SEL)selector
{
    return [self processRequestAsynchronous:@"api.twitter.com/1/lists/members/create.json" method:@"POST" params:params type:CBTwitterResponseTypeCustom class:[CBUser class] delegate:delegate selector:selector];    
}
...
{
    return [self processRequestSynchronous:@"api.twitter.com/1/lists/members/create_all.json" method:@"POST" params:params type:CBTwitterResponseTypeCustom class:[CBUser class] error:error];
}

+ (CBRequestId*) addMembersToList:(CBAddMembersToListParams*)params delegate:(id)delegate selector:(SEL)selector
{
    return [self processRequestAsynchronous:@"api.twitter.com/1/lists/members/create_all.json" method:@"POST" params:params type:CBTwitterResponseTypeCustom class:[CBUser class] delegate:delegate selector:selector];    
}
